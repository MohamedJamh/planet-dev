        ...
        <div class="flex justify-between">
            <div class="flex">
                <a href="" class="flex align-center">
                    ...
                    <span class="self-center text-xl font-semibold ">Dev Plannet</span>
                </a>
            ...
            <div class="flex">
                ...
                <button  class=" text-gray-500 hover:bg-gray-100 rounded-lg text-sm px-2.5 mr-1" >
   ...
   <div class="container flex flex-wrap items-center justify-between mx-auto">
      <div class="flex">
        <a href="https://flowbite.com/" class="flex items-center">
            ...
            <span class="self-center text-xl font-semibold whitespace-nowrap ">Dev Plannet</span>
        </a>
        <div class="relative hidden md:block mx-4">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
               <svg class="w-5 h-5 text-gray-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <button type="button" class=" text-gray-500 hover:bg-gray-100 rounded-lg text-sm p-2.5 mr-1" >
        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
        </svg>
        <span class="sr-only">Search</span>
