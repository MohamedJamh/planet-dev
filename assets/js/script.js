                            ...
                            <div>
                                ...
                                <div id="dropdownDotsHorizontal" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                        <li>
                                            <a  data-modal-target="extralarge-modal-2" onclick="listArticleInfo('article-${article["id_article"]}');" data-modal-toggle="extralarge-modal-2" class="block px-4 py-2 hover:bg-gray-100">Edit</a>
                                        </li>
                                        <li>
                                            <a href="#" onclick="delete('article-${article["id_article"]}');" class="block px-4 py-2 hover:bg-gray-100 ">Delet</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
function listArticleInfo(idArticle){
    $('#editForm .article-title').val($(`#${idArticle} .article-title`).html())
    $('#editForm .article-title').val($(`#${idArticle} .article-content`).html())
}
