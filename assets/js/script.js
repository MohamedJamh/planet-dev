...
$.post("assets/core/script.php",{ list : true}, function(data,status){listArticles(data)},"json");
...
//         let articleDiv = `
//                 <div id="article-${id}" class="py-5 flex flex-col items-center border-b md:flex-row md:w-full border-gray-300 bg-white">
...
//                                         <li>
//                                             <a  data-modal-target="extralarge-modal-2" onclick="alert(${id+1});" data-modal-toggle="extralarge-modal-2" class="block px-4 py-2 hover:bg-gray-100">Edit</a>
//                                         </li>
//                                         <li>
//                                             <a href="#" onclick="delete(${id});" class="block px-4 py-2 hover:bg-gray-100 ">Delet</a>
//                                         </li>
//                                     </ul>
//                                 </div>
//                             </div>
...
function listArticleInfo(idArticle){
    ...
    //     console.log(data);
    //     $('#editForm .article-title').val(`${data[0]['title']}`)
    //     $('#editForm .article-content').val(`${data[0]['content']}`)
    //     $('#editForm .article-categorie').val(`${data[0]['id_categorie']}`);
    //     $('#editForm .author').val(`${data[0]['id_author']}`);
    // },"json");
}
...
// $.ajax({
//     url: `assets/core/script.php?tt=1`,
//     dataType: "json",
//     success: (data,status) => {
//         console.log(data);
//     }
...
function formDuplicate(){
    let headerdiv = `
        <div class="flex justify-end" onclick="deleteArticleForm('form-${formCounter}');$(this).remove();">
            <button type="button" class="hover:bg-red-300 hover:duration-700 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
