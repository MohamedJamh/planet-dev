...
<body>
    <div id="home" class="h-screen text-base text-white bg-cover">
        <div class="bg-black/40 h-screen grid place-content-center">
            <div class="w-100 md:w-4/5 px-4 py-4 mx-auto align-middle md:rounded-lg">
                <?php if (isset($GLOBALS['message'])): ?>
                    <div class="flex p-4 my-4 text-base text-red-900 bg-red-100 rounded-lg dark:bg-gray-800 dark:text-red-400" role="alert">
                        <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                        <span class="sr-only">Info</span>
                        <div>
                            <span class="font-base">Alert!</span> <?php echo $GLOBALS['message'];unset($GLOBALS['message']);?>
                        </div>
                    </div>
                <?php endif; ?>
                <p class="text-center leading-relaxed font-bold text-base md:text-xl ">Planet Dev is a community where authors can share and read articles about recent technologies on development domain and other various topics. The site is designed for developers, by developers, and is a platform for software engineers, developers, and programmers to share their knowledge, experience and insights. The site features articles and tutorials on a wide range of topics, including programming languages, frameworks, tools, and best practices.</p>
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="" method="POST">
                        <div>
                            ...
                            <input type="email" name="adress" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@company.com" required>
                        </div>
                        <div>
